# Sairon_World Agent Guide

This repository hosts a static interactive map editor for the Sairon world. The app renders a map background and overlays editable lands, roads/bridges, POIs, rivers, walls, and terrain paint layers. The code is plain HTML/CSS/JS; there is no build step.
