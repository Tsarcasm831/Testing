...
export const TARGET_SPAWN_USERNAME = "lordtsarcasm";
/* @tweakable The special spawn location coordinates. */
export const SPECIAL_SPAWN_LOCATION = { x: 44.1, y: 13.7, z: 21.4 };
/* @tweakable The target username for the post-load teleport. */
export const TELEPORT_USERNAME = "lordtsarcasm";
/* @tweakable The coordinates to teleport the user to after their special GLB model loads. */
export const TELEPORT_LOCATION = { x: 53.8, y: 14, z: 0.0 };