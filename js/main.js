        ...
        const setupGlobalEventListeners = () => {
            ...
            app.ui.DOMElements.modalProjectLink?.addEventListener('click', (e) => {
                ...
                if (link && link.dataset.page) {
                    e.preventDefault();
                    app.router.loadPage(link.dataset.page);
                    app.ui.closeModal();
                }
            });
            app.ui.DOMElements.mainNav?.addEventListener('click', (e) => app.router.handleNavClick(e));
            window.addEventListener('popstate', (e) => app.router.handlePopState(e));
