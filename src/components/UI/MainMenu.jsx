...
const MainMenu = ({ onStart, onOptions, onChangelog }) => {
  return /* @__PURE__ */ jsxDEV(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxDEV("div", { className: "bg-black bg-opacity-60 p-12 rounded-xl shadow-2xl border-2 border-yellow-500 flex flex-col items-center gap-6 backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxDEV("h1", { className: "text-6xl font-bold text-yellow-400 font-serif tracking-widest drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)]", children: "Open World RPG" }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 10,
          columnNumber: 17
        }),
        /* @__PURE__ */ jsxDEV("p", { className: "text-gray-300 -mt-4", children: "v0.001.6" }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 13,
          columnNumber: 17
        }),
