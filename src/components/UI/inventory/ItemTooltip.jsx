  ...
  return /* @__PURE__ */ jsxDEV(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxDEV("div", { className: "space-y-2", children: [
        ...
        item.type && (item.type === "health" || item.type === "mana" || item.type === "special") && /* @__PURE__ */ jsxDEV("div", { className: "border-t border-gray-600 pt-2", children: /* @__PURE__ */ jsxDEV("p", { className: "text-xs text-gray-400 italic", children: "Right-click to use." }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 75,
          columnNumber: 15
        }) }, void 0, false, {
